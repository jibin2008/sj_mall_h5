<template>
	<div :class="{ 'uni-card--full': isFull === true || isFull === 'true', 'uni-card--shadow': isShadow === true || isShadow === 'true' }" class="uni-card" @click="onClick">
		<div v-if="mode === 'style'" class="uni-card__thumbnailimage">
			<div class="uni-card__thumbnailimage-box">
				<image class="uni-card__thumbnailimage-image" :src="thumbnail" mode="aspectFill" />
			</div>
			<div v-if="title" class="uni-card__thumbnailimage-title"><text class="uni-card__thumbnailimage-title-text">{{ title }}</text></div>
		</div>
		...
		<div v-if="mode === 'basic' && title" class="uni-card__header">
			<div v-if="thumbnail" class="uni-card__header-extra-img-view">
		...
		<div class="uni-card__content uni-card__content--pd">
			<div v-if="mode === 'style' && extra" class=""><text class="uni-card__content-extra">{{ extra }}</text></div>
			<slot />
		</div>
		<!-- 底部 -->
