<template>
	<div class="uni-swiper__warp">
		<slot />
		<div v-if="mode === 'default'" :style="{'bottom':dots.bottom + 'px'}" class="uni-swiper__dots-box" key='default'>
		...
		<div v-if="mode === 'dot'" :style="{'bottom':dots.bottom + 'px'}" class="uni-swiper__dots-box" key='dot'>
			<div v-for="(item,index) in info" :style="{
		...
		<div v-if="mode === 'round'" :style="{'bottom':dots.bottom + 'px'}" class="uni-swiper__dots-box" key='round'>
			<div v-for="(item,index) in info" :class="[index === current&&'uni-swiper__dots-long']" :style="{
