<template>
	<div class="uni-rate">
		<div :key="index" :style="{ marginLeft: margin + 'px' }" @click="_onClick(index)" class="uni-rate__icon" v-for="(star, index) in stars">
			<uni-icons :color="color" :size="size" :type="isFill ? 'star-filled' : 'star'" />
			<!-- #ifdef APP-NVUE -->
			<div :style="{ width: star.activeWitch.replace('%','')*size/100+'px'}" class="uni-rate__icon-on">
				<uni-icons style="text-align: left;" :color="activeColor" :size="size" type="star-filled" />
			</div>
			<!-- #endif -->
			<!-- #ifndef APP-NVUE -->
			<div :style="{ width: star.activeWitch,top:-size/2+'px' }" class="uni-rate__icon-on">
