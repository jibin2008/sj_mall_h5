<template>
	<div class="w-picker-view">
		<picker-view class="d-picker-view" :indicator-style="itemHeight" :value="pickVal" @change="handlerChange">
			<picker-view-column>
				<div class="w-picker-item" v-for="(item,index) in range.provinces" :key="index">{{item.label}}</div>
			</picker-view-column>
			<picker-view-column>
				<div class="w-picker-item" v-for="(item,index) in range.citys" :key="index">{{item.label}}</div>
			</picker-view-column>
			<picker-view-column v-if="!hideArea">
				<div class="w-picker-item" v-for="(item,index) in range.areas" :key="index">{{item.label}}</div>
			</picker-view-column>
		</picker-view>
	</div>
</template>
