	...
	<div class="w-picker-view">
		<picker-view  class="d-picker-view" :indicator-style="itemHeight" :value="pickVal" @change="handlerChange">
			<picker-view-column class="w-picker-flex2">
				<div class="w-picker-item" v-for="(item,index) in range.fyears" :key="index">{{item}}年</div>
			</picker-view-column>
			<picker-view-column class="w-picker-flex2">
				<div class="w-picker-item" v-for="(item,index) in range.fmonths" :key="index">{{item}}月</div>
			</picker-view-column>
			<picker-view-column class="w-picker-flex2">
				<div class="w-picker-item" v-for="(item,index) in range.fdays" :key="index">{{item}}日</div>
			</picker-view-column>
			<picker-view-column class="w-picker-flex1">
				<div class="w-picker-item">-</div>
			</picker-view-column>
			<picker-view-column class="w-picker-flex2">
				<div class="w-picker-item" v-for="(item,index) in range.tyears" :key="index">{{item}}年</div>
			</picker-view-column>
			<picker-view-column class="w-picker-flex2">
				<div class="w-picker-item" v-for="(item,index) in range.tmonths" :key="index">{{item}}月</div>
			</picker-view-column>
			<picker-view-column class="w-picker-flex2">
				<div class="w-picker-item" v-for="(item,index) in range.tdays" :key="index">{{item}}日</div>
			</picker-view-column>
		</picker-view>
	</div>
</template>
