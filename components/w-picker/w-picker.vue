<template name="w-picker">
	<div class="w-picker" :key="createKey" :data-key="createKey">
		<div class="mask" :class="{'visible':visible}" @tap="onCancel" @touchmove.stop.prevent catchtouchmove="true"></div>
		<div class="w-picker-cnt" :class="{'visible':visible}">
			<div class="w-picker-header"  @touchmove.stop.prevent catchtouchmove="true">
