<template>
	<div class="w-picker-view">
		<picker-view class="d-picker-view" :indicator-style="itemHeight" :value="pickVal" @change="handlerChange">
			<picker-view-column>
				<div class="w-picker-item" v-for="(item,index) in range.dates" :key="index">{{item.label}}</div>
			</picker-view-column>
			<picker-view-column>
				<div class="w-picker-item" v-for="(item,index) in range.hours" :key="index">{{item.label}}时</div>
			</picker-view-column>
			<picker-view-column>
				<div class="w-picker-item" v-for="(item,index) in range.minutes" :key="index">{{item.label}}分</div>
			</picker-view-column>
		</picker-view>
	</div>
</template>
