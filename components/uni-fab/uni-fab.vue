<template>
	<div>
		<div v-if="popMenu && (leftBottom||rightBottom||leftTop||rightTop)" :class="{
        ...
        'uni-fab--rightTop': rightTop
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
				...
				<div v-if="flexDirectionStart || horizontalLeft" class="uni-fab__item uni-fab__item--first" />
				<div v-for="(item, index) in content" :key="index" :class="{ 'uni-fab__item--active': isShow }" class="uni-fab__item" @click="_onItemClick(index, item)">
		...
		<div :class="{
		  ...
		  'uni-fab__content--other-platform': !isAndroidNvue
			...
			<div class="fab-circle-v" :class="{'uni-fab__plus--active': isShow}"></div>
			<div class="fab-circle-h" :class="{'uni-fab__plus--active': isShow}"></div>
		</div>
	</div>
</template>
