<template>
	...
	<cell>
		<!-- #endif -->
		<div :class="disabled ? 'uni-list-item--disabled' : ''" :hover-class="disabled || showSwitch ? '' : 'uni-list-item--hover'"
		 class="uni-list-item" @click="onClick">
			<div class="uni-list-item__container" :class="{'uni-list-item--first':isFirstChild}">
