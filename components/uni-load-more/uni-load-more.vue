<template>
	<div class="uni-load-more" @click="onClick">
		...
		<!-- #endif -->
		<!-- #ifndef APP-NVUE || H5 -->
		<div v-if="!webviewHide && (iconType==='circle' || iconType==='auto' && platform === 'android') && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--android-MP">
			<div :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></div>
			<div :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></div>
			<div :style="{borderTopColor:color,borderTopWidth:iconSize/12}"></div>
		</div>
		<!-- #endif -->
		<!-- #ifndef APP-NVUE -->
		<div v-else-if="!webviewHide && status === 'loading' && showIcon" :style="{width:iconSize+'px',height:iconSize+'px'}" class="uni-load-more__img uni-load-more__img--ios-H5">
